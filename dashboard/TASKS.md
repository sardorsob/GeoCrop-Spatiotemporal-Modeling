...
- QA notes:
  ...
  - Follow-up QA 2026-09-24: Rebuilt the production app and passed all four shell tests. In the Codex browser, clicking Paper opened the named reader; iframe, open, and download targets all used `/papers/Reading_the_Corn_Belt.pdf`. An HTTP request returned 200 with Content-Type `application/pdf` and bytes identical to all three canonical copies (10 pages, SHA-256 `5662b09a424608f29421fb529d3e81e74374a4fc2f1ca293a5f0bf7b51de94f1`). The obsolete public filename returned 404. Corrected the remaining README reference and synchronized PROJECT status. No runtime or dependency changes were needed.
- Attempts: 1
- Max attempts: 3
- Attempt log:
