...
\begin{figure}[htbp]
\centering\includegraphics[width=\linewidth]{rewrite/figures/rotation.pdf}
...
{\centering\small\textbf{GitHub: }\url{https://github.com/sardorsob/GeoCrop-Spatiotemporal-Modeling}\par}
...
\input{rewrite/sections/phenology_rotation}
\input{rewrite/sections/moisture}
...
\input{rewrite/sections/classification}
